...
def translate_error(message: str) -> str:
    mapping = {
        ...
        "resource_presets must be an array of strings": "资源类型快捷识别配置格式不正确，请重新选择后保存。",
    ...
    if "resource_presets[" in message and "is invalid" in message:
        return "你选择的资源类型快捷识别项有无效值，请重新勾选后再保存。"
