...
class ProcessSupervisor:
    def __init__(
        ...
        *,
        child_log_queue: mp.Queue | None = None,
    ):
    ...
    def _start_dispatcher(self) -> None:
        ...
        process = mp.Process(
            ...
            args=(
                ...
                str(self.queue_db_path),
                stop_event,
                self._child_log_queue,
            ),
        )
        process.start()
        with self._lock:
    ...
    def _start_worker(
        ...
        *,
        ...
        stop_event = mp.Event()
        worker_payload = runtime.as_payload()
        worker_payload["_config_path"] = str(self.config_path)
        process = mp.Process(
