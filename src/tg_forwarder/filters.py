...
async def explain_message_match(message: Message, filters: FilterConfig) -> MessageMatchResult:
    ...
    evaluation = evaluate_keyword_filters_detailed(
        ...
        + build_resource_preset_specs(filters.resource_presets, filters.case_sensitive),
    ...
    return build_message_match_result(
        ...
        source=MATCH_VIA_MESSAGE if evaluation.matched else MATCH_VIA_NONE,
